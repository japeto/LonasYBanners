<?php
	...
	echo "<caption>RESULTADOS DE LA BUSQUEDA<font id='countproduct' style='float:right;' color='black'> ".$count." Resultados</font>";
		echo '<form action="core/c-export.php" method="post" target="_blank" id="FormularioExportacion">
<img class="imgbutton" id="exportproduct" src="shared/thumbs/btexcel.png" align="right" style="padding-right:5px;">
<input type="hidden" id="datos_a_enviar" name="datos_a_enviar" />
<input type="hidden" id="nameexport" name="nameexport" />
</form>';
		echo "<a class='imgbutton' id='prnt'  onclick='printproduct(this)' >";
