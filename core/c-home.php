...
//	echo "<caption><font size='3' style='float:left;color:silver;text-decoration:underline;' >¿Que quieres hacer?</font><caption>";
	...
	echo "<b class='imgbutton' style='color:#0194EF;'>Nueva venta</b></a>";
	echo "</td>";
